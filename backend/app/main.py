...
from app.services.generation_record_service import retention_sweeper
...
async def lifespan(_: FastAPI):
    ...
    worker.start()
    # Standalone image/video results expire on the admin-configured schedule; see
    # `generation_record_service.RetentionSweeper`.
