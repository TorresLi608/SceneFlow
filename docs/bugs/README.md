...
|---|---|---|---|---|---|
| BUG-20260918-chat-image-tool-result-display | 智能问答、生成图片、generate_image、执行流程、agent_step、工具失败、Streamdown img | 图片工具结果只在流程框显示 JSON/URL，失败步骤显示为 done 且正文无提示；现正文内联渲染图片并回填成功产物/失败提示 | 后端回归与类型检查通过，lint 与浏览器待验证 | 2026-09-18 | [聊天图片工具结果展示](2026-09-18-chat-image-tool-result-display.md) |
