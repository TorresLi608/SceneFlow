  ...
  video: [
    {
      ...
      label: "Doubao",
      modelSeries: "",
      modelPlaceholder: "doubao-seedance-2.0 / doubao-seedance-2.0-fast",
      baseUrl: "https://ark.cn-beijing.volces.com/api/v3",
    ...
    },
    {
      ...
      label: "Qwen",
      modelSeries: "",
      modelPlaceholder: "wan2.7-t2v / wan2.7-i2v / wan2.7-r2v",
      baseUrl: "https://dashscope.aliyuncs.com/api/v1",
  ...
  audio: [
    {
      ...
      modelSeries: "qwen3-tts-vd-realtime-2025-12-16",
      modelPlaceholder: "qwen3-tts-vd-realtime-2025-12-16",
      baseUrl: "https://dashscope.aliyuncs.com/api/v1",
